...
export class AuthService {
  ...
  async generateRegisterSession(phone: string, requestId: string, uuid: string, userId: string, guestId: string) {
    const payload = {
      phone: phone,
      requestId: requestId,
      uuid: uuid,
  ...
  async login(dto: LoginDto, guestId: string) {
    ...
    // Store hashed refresh token so /auth/refresh can validate it (rotation)
  ...
  async initUserCompleteRegistration(userId: string, guestId: string) {
